				...
				<tr>
					<td align=center>
						<table border=0 width=100% align=center>
							<tr>
								<td width=10%>성 명</td>
								<td width=90%><input type=text name=b_name size=10
									maxlength=8></td>
							</tr>
							<tr>
								<td width=10%>E-Mail</td>
								<td width=90%><input type=text name=b_email size=30
									maxlength=30></td>
							</tr>
							<tr>
								<td width=10%>홈페이지</td>
								<td width=90%><input type=text name=b_homepage size=40
									maxlength=30></td>
							</tr>
							<tr>
								<td width=10%>제 목</td>
								<td width=90%><input type=text name=b_subject size=50
									maxlength=30 value="답변:<%=subject%>"></td>
							</tr>
							<tr>
								<td width=10%>내 용</td>
							...
							<tr>
								...
								<td width=90%><input type=password name=b_pass size=15
									maxlength=15></td>
							</tr>
							<tr>
